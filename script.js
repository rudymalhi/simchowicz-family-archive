...
const t = {
  en: {
    ...
    places: {
      ...
      cards: [
        ["01", "Berlin", "Birth, schooling, work, and the family home documented at Grenadierstraße 14."],
    ...
    sources: {
      ...
      ledger: [
        ...
        ["פאולה מסמכים.pdf", "Direct documents", "Grenadierstraße 14; death certificate; Red Cross records; correspondence from 1939–1940."],
    ...
    footer: { eyebrow: "A living archive", note: "Built from family documents, a family spreadsheet, and public archival context. Last updated 1 September 2026.", privacy: "Living people are not profiled here; uncertain claims are labelled.", sources: "View sources" }
  },
  he: {
    ...
    places: {
      ...
      cards: [
        ["01", "ברלין", "לידה, לימודים, עבודה, ובית המשפחה המתועד בגרנָדירשטראסה 14."],
  ...
  de: {
    ...
    footer: { eyebrow: "Ein lebendes Archiv", note: "Erstellt aus Familiendokumenten, einer Familientabelle und öffentlichem Archivkontext. Aktualisiert am 1. September 2026.", privacy: "Lebende Personen werden hier nicht profiliert; unsichere Angaben sind gekennzeichnet.", sources: "Quellen ansehen" }
  }
};
