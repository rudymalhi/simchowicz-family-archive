...
const t = {
  en: {
    ...
    updates: {
      kicker: "Research update · 2 September 2026",
      ...
      cards: [
        ...
        ["confirmed", "A probable Berlin household appears in Arolsen", "Arolsen cards identify Rosa (1 January 1922), Minni (7 September 1924), and Sascha/Susi (18 December 1929), all Berlin-born Polish citizens with father Mates and mother Erna/Ester née Offen. They are highly probable siblings of Paula, although Paula is not named on these cards.", `<a href="${external.arolsenRosa}" target="_blank" rel="noreferrer">Rosa ↗</a> · <a href="${external.arolsenMinni}" target="_blank" rel="noreferrer">Minni ↗</a> · <a href="${external.arolsenSascha}" target="_blank" rel="noreferrer">Sascha ↗</a> · <a href="${external.arolsenSusi}" target="_blank" rel="noreferrer">Susi ↗</a>`],
    ...
    family: {
      ...
      leadText: "Arolsen cards now identify Rosa, Minni, and Sascha/Susi as Berlin-born Polish citizens with father Mates and mother Erna/Ester née Offen. Their dates fit Paula’s probable sibling group. The cards support the household, but they do not themselves name Paula.",
      leadLinks: `<a href="${external.arolsenRosa}" target="_blank" rel="noreferrer">Rosa’s Arolsen card ↗</a> · <a href="${external.arolsenMinni}" target="_blank" rel="noreferrer">Minni’s card ↗</a> · <a href="${external.addressBook}" target="_blank" rel="noreferrer">1929 address record ↗</a>`,
  ...
  he: {
    ...
    updates: {
      kicker: "עדכון מחקר · 2 בספטמבר 2026",
      ...
      cards: [
        ...
        ["confirmed", "משק בית ברלינאי אפשרי בארולסן", "כרטיסי ארולסן מזהים את רוזה (1 בינואר 1922), מיני (7 בספטמבר 1924) וסשה/סוזי (18 בדצמבר 1929), ילידי ברלין ובעלי אזרחות פולנית, עם האב מתי והאם ארנה/אסתר לבית אופן. התאריכים מתאימים מאוד לקבוצת האחים של פאולה, אך הכרטיסים אינם מזכירים את פאולה עצמה.", `<a href="${external.arolsenRosa}" target="_blank" rel="noreferrer">רוזה ↗</a> · <a href="${external.arolsenMinni}" target="_blank" rel="noreferrer">מיני ↗</a> · <a href="${external.arolsenSascha}" target="_blank" rel="noreferrer">סשה ↗</a> · <a href="${external.arolsenSusi}" target="_blank" rel="noreferrer">סוזי ↗</a>`],
    ...
    family: {
      ...
      parent2: ["אסתר / ארנה שמחוביץ", "בערך 1896 · פולין", "לבית אופן בכרטיסי ארולסן; מקום הלידה ממקור משפחתי"],
      leadTitle: "ארולסן מוסיף משק בית אפשרי",
      leadText: "כרטיסי ארולסן מזהים את רוזה, מיני וסשה/סוזי כילידי ברלין בעלי אזרחות פולנית, עם האב מתי והאם ארנה/אסתר לבית אופן. התאריכים מתאימים לקבוצת האחים האפשרית של פאולה. הכרטיסים תומכים במשק הבית, אך אינם מזכירים את פאולה עצמה.",
      leadLinks: `<a href="${external.arolsenRosa}" target="_blank" rel="noreferrer">כרטיס רוזה בארולסן ↗</a> · <a href="${external.arolsenMinni}" target="_blank" rel="noreferrer">כרטיס מיני ↗</a> · <a href="${external.addressBook}" target="_blank" rel="noreferrer">רשומת הכתובת משנת 1929 ↗</a>`,
    ...
    timeline: {
      ...
      events: [
        ["1919", "לידה בברלין", "פאולה נולדה ב־22 ביוני 1919 בשם פאולה שמחוביץ, בתם של מתי ואסתר שמחוביץ.", "קורות חיים · רישום ברלינאי · תעודת פטירה"],
  ...
  de: {
    ...
    updates: {
      kicker: "Forschungsupdate · 2. September 2026",
      ...
      cards: [
        ...
        ["confirmed", "Ein wahrscheinlicher Berliner Haushalt im Arolsen-Archiv", "Arolsen-Karten identifizieren Rosa (1. Januar 1922), Minni (7. September 1924) und Sascha/Susi (18. Dezember 1929), alle in Berlin geboren und polnische Staatsangehörige, mit dem Vater Mates und der Mutter Erna/Ester geborene Offen. Die Daten passen sehr gut zu Paulas wahrscheinlichen Geschwistern; Paula selbst wird auf diesen Karten jedoch nicht genannt.", `<a href="${external.arolsenRosa}" target="_blank" rel="noreferrer">Rosa ↗</a> · <a href="${external.arolsenMinni}" target="_blank" rel="noreferrer">Minni ↗</a> · <a href="${external.arolsenSascha}" target="_blank" rel="noreferrer">Sascha ↗</a> · <a href="${external.arolsenSusi}" target="_blank" rel="noreferrer">Susi ↗</a>`],
    ...
    family: {
      ...
      leadText: "Arolsen-Karten identifizieren Rosa, Minni und Sascha/Susi als in Berlin geborene polnische Staatsangehörige mit dem Vater Mates und der Mutter Erna/Ester geborene Offen. Die Daten passen zur wahrscheinlichen Geschwistergruppe von Paula. Die Karten stützen den Haushalt, nennen Paula aber nicht.",
      leadLinks: `<a href="${external.arolsenRosa}" target="_blank" rel="noreferrer">Rosas Arolsen-Karte ↗</a> · <a href="${external.arolsenMinni}" target="_blank" rel="noreferrer">Minnis Karte ↗</a> · <a href="${external.addressBook}" target="_blank" rel="noreferrer">Adressbucheintrag von 1929 ↗</a>`,
